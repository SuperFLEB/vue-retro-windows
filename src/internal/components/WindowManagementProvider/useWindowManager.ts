...
import {Win as w, WinMan as wm} from "@int/components/WindowManagementProvider/keys.ts";
import type {WinInterface} from "@int/components/WindowManagementProvider/WindowProvider.vue";
import type {WindowProps} from "@t/WinMan.ts";
import {ComposableOutOfContextError} from "@int/errors.ts";
import type {WinManInterface} from "@int/components/WindowManagementProvider/WinManProvider.vue";
