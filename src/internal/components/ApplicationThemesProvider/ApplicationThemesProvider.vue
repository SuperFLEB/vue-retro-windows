...
import savedThemeKeyName from "@int/components/ApplicationThemesProvider/savedThemeKeyName.ts";

// This needs to be a shallowRef because it comtains a deep structure including components
