...
import {type ScrollState, ScrollStateActionSource} from "@int/components/ScrollBar/types.ts";
...
import debug from "@int/debug";
import type {ScrollInterface} from "@int/components/ScrollBar/ScrollProvider.vue";
import type {ThemeProviderInterface} from "@int/components/ThemeProvider/types.ts";
