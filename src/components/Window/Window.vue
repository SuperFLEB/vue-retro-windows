...
import WindowProvider from "@/components/WindowManagementProvider/WindowProvider.vue";
import type {ValidPartialWindowProps} from "@t/WinMan.ts";
import {createWindowProps, defaultWindowProps} from "./props.ts";
import {onMounted} from "vue";
import {useWindowManager} from "@/components/WindowManagementProvider/useWindowManager.ts";
