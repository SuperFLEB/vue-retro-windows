...
import {Win as w, WinMan as wm} from "@/components/WindowManagementProvider/keys.ts";
import type {WinInterface} from "@/components/WindowManagementProvider/WindowProvider.vue";
