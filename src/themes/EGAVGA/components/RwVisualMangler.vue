	...
	<svg class="filters" width="1" height="1">
		<defs>
			...
			<filter id="bw" x="0" y="0" width="100%" height="100%">
				...
				<feComponentTransfer in="SourceGraphic" result="isolateBlack" color-interpolation-filters="sRGB">
					<template v-for="comp in components">
						<component :is="'feFunc' + comp" type="discrete" tableValues="0 1 1 1"></component>
					</template>
				</feComponentTransfer>

				<feComponentTransfer in="SourceGraphic" result="isolateLight" color-interpolation-filters="sRGB">
					<template v-for="comp in components">
						<component :is="'feFunc' + comp" type="discrete" tableValues="1 1 0 1"></component>
					</template>
				</feComponentTransfer>

				<feComponentTransfer in="SourceGraphic" result="isolateDark" color-interpolation-filters="sRGB">
					<template v-for="comp in components">
						<component :is="'feFunc' + comp" type="discrete" tableValues="1 0 1 1"></component>
					</template>
				</feComponentTransfer>

				<feComponentTransfer in="SourceGraphic" result="isolateWhite" color-interpolation-filters="sRGB">
					<template v-for="comp in components">
