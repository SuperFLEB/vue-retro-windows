...
export const RwWindowChrome = themedComponent("RwWindowChrome");
export const RwWindowDragProxy = themedComponent("RwWindowDragProxy");
export const RwDesktop = themedComponent("RwDesktop");
export const RwWindowPane = themedComponent("RwWindowPane");
export const RwScrollBars = themedComponent("RwScrollBars");
export const RwScrollBarX = themedComponent("RwScrollBarX");
