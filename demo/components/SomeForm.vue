...
<template>
	<form class="regForm">
		...
		<div>
			<label for="feeling">How does @superfleb/vue-windows make you feel?</label>
			<textarea id="feeling"></textarea>
		</div>
		<div>
			<input type="checkbox" id="spam"/>
			<label for="spam"> Spam me incessantly with newsletters I don't care about.</label>
		</div>
	</form>
</template>

<style scoped>
	.regForm label:first-child {
